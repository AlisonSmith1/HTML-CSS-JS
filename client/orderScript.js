...
async function fetchOrder() {
  ...
  try {
    const res = await fetch(`${API_URL}/api/commodity/getOrder`, {
      headers: {
...
document
  ...
  .addEventListener("click", async function (e) {
    ...
    try {
      const res = await fetch(`${API_URL}/api/commodity/order/${userId}`, {
        method: "POST",
        headers: {
...
async function reduceQuantity(cart) {
  ...
  try {
    const res = await fetch(
      `${API_URL}/api/commodity/reduceQuantity/${userId}`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
...
async function cleanCartItems() {
  ...
  try {
    const res = await fetch(
      `${API_URL}/api/commodity/cleanCartItems/${userId}`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
